# УП - Практикум 19.11.2025, Седмица 7
...
**Задача 8:** Да се напише функция, която приема число `n` в десетична бройна система и основа на бройна система `k` и връща дали числото `n` е палиндром в бройната система с основа `k`.
