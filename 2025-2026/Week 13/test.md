...
### *Забранено е използването на библиотеки различни от std:iostream*
...
която е фиксирана предварително ( максимална дължина 1000), където:
...
съответно брой редове и брой колони в матрица от реални числа, като елементите
...
с координати $(x_i,y_i)$ са тези елементи с координати $(x_j, y_j)$,
за които е вярно, че: $|i - j| \leq 1$ \& $|i - j| \leq 1$.
